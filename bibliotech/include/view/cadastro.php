...
<html lang="pt-br">
  ...
  <body class="text-center">
    <form class="form-signin" method="post" action="">
      ...
      <input type="text" id="inputNome" class="form-control" name="nome" placeholder="João da Silva" required autofocus>
      <label for="inputEmail" class="sr-only">E-mail</label>
      <input type="email" id="inputEmail" class="form-control" name="email" placeholder="exemplo@exemplo.com" required>
      <label for="inputPassword" class="sr-only">Senha</label>
      <input type="password" id="inputPassword" class="form-control" name="passwd" placeholder="*******" required>
